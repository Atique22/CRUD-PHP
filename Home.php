...
<body>
        ...
        <div class="container px-24 py-24 mx-auto sm:mr-5 p-5 flex float-left">
          <div class="lg:w-2/5 md:w-1/2 bg-white rounded-lg p-8 flex flex-col shadow-md">
        ...
        <form action="crud.php" method="post">
            ...
            <button class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Register</button>
          </form>
            ...
            <div class="lg:w-3/6 mx-auto overflow-auto float-right">
              <table class="table-auto w-full text-left whitespace-no-wrap">
                <thead>
                  <tr>
                    <th class="px-3 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">Reg. ID</th>
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Name</th>
                    <th class="px-3 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Email</th>
                    <th class="px-3 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">Phone</th>
                ...
                <tbody>
                  ...
                  ?>
                      <tr>
                                  ...
                                  <td class="px-4 py-3 text-red-600"><a href="crud.php?Remove=<?php echo $row['Reg_id']; ?>" ><button name='Delete' type="button" class="bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white py-1 px-4 border border-red-500 hover:border-transparent rounded">
                                  Delete</button></a></td>
